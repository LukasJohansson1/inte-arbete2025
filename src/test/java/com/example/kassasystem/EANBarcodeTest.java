...
class EANBarcodeTest {
    ...
    void testEANBarcodeConstructor_invalidLength_throwsException(String code) {
    ...
    void testEANBarcodeConstructor_invalidCharacters_throwsException(String code) {
        assertThrows(IllegalArgumentException.class, () -> new EANBarcode(code));
    }

    @ParameterizedTest
    @ValueSource(strings = {"8901234567891", "1234567890123", "23456780", "12345671"})
    void testEANBarcodeConstructor_invalidCheckDigit_throwsException(String code) {
        assertThrows(IllegalArgumentException.class, () -> new EANBarcode(code));
    }

    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testEANBarcodeConstructor_validBarcodes(String code) {
        EANBarcode ean = new EANBarcode(code);
        assertEquals(code, ean.code());
    }

    @Test
    void testEANBarcodeConstructor_null_throwsException() {
        assertThrows(IllegalArgumentException.class, () -> new EANBarcode(null));
    }

    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testEquals_shouldBeEqual(String code) {
        assertEquals(new EANBarcode(code), new EANBarcode(code));
    }

    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testEquals_sameObject(String code) {
        EANBarcode ean = new EANBarcode(code);
    ...
    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testEquals_differentCodes_notEquals(String code) {
        assertNotEquals(new EANBarcode("4003994155486"), new EANBarcode(code));
    }

    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testEquals_differentType_notEquals(String code) {
        assertNotEquals(code, new EANBarcode(code));
    }

    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testEquals_null_notEquals(String code) {
        assertNotEquals(null, new EANBarcode(code));
    }

    @ParameterizedTest
    @ValueSource(strings = {"4006381333931", "5012345678900", "96385074", "73513537"})
    void testHashCode_equalsObjects(String code) {
